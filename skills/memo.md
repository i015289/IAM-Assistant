---
name: memo
description: Use this skill when the user wants to save, load, list, or manage IAM analysis memos. Memos persist findings, decisions, work-in-progress, and known-good baselines across sessions. Trigger on /memo, "save memo", "remember this", "load memo", "what did we find", "resume", or "show memos".
---
